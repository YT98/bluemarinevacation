          ...
          {({p, o}) =>
            <div class="row home-intro">
              ...
              <div class="col-md-8 col-sm-8">
                <p style={{ transform: `translateX(${-p}px)`, opacity: `${o}`}}> Nous sommes Holiday Homes 7, une entreprise d’investissements immobiliers. Situés à St-Martin, nous sommes en mesure de vous procurer villas et appartements, terrains et locaux de qualité dans le décor de rêve qu’est cette merveilleuse île: collines verdoyantes, plages de sable fin, eau turquoise à perte de vue… St-Martin ne manque pas de facettes à découvrir !</p>
              </div>
            </div>
          }
        </Motion>
